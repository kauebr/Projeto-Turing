...
Modelo preditivo de risco de suicídio em desenvolvimento com **PySpark**, utilizando dados abertos do **DataSUS** e do **IBGE**, desenvolvido dentro **Laboratório Nacional de Dados**.
